...
class Ceicom_CustomerAccount_Frontend_AccountController extends Mage_Customer_AccountController
{
    /**
    ...
    public function editPostAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            */
            ...
            if (Mage::helper('ceicom_customeraccount')->isTaxvatEditable()) {
                $this->getRequest()->setParam('taxvat',$customerForm->getEntity()->getData('taxvat'));
            }
