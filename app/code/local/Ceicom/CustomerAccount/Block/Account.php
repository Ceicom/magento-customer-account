...
class Ceicom_CustomerAccount_Block_Account extends Mage_Adminhtml_Block_Customer_Edit_Tab_Account
{
    /**
     * Initialize form
     *
...
//        }
        ...
        */
        ...
        $fieldset->addField('taxvatUI', 'text', array(
            'label'     => Mage::helper('ceicom_customeraccount')->__('Tax/VAT Number'),
            'class'     => 'taxvatUI',
            'required'  => $taxvat->getIsRequired(),
            'data-type' => 'taxvat',
            'name'      => 'taxvatUI'
        ));
        $customer->setData('taxvatUI', $customer->getData('taxvat'));

        $form->getElement('taxvat')->setClass('taxvatUI')->setType('hidden');
